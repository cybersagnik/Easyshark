...
OLLAMA_SYSTEM_PROMPTS = {
    ...
    "explainer": (
        ...
        "  Docx / file content: extract_files (text_preview is provided automatically for docx)\n\n"
        "RULES (strictly follow):\n"
        ...
        "3. If you call extract_files and find a .docx file, look at its "
        "'text_preview' field — that field already contains the parsed "
        "document text and often IS the answer.\n"
